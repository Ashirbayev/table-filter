...
import data from '../assets/data'; // Adjust path as necessary

interface User {
  _id: string;
  isActive: boolean;
  balance?: string; // Mark as optional
  picture: string;
  age: number;
  name: {
    first: string;
...
export class AppComponent implements OnInit {
  initialDisplayedColumns: string[] = ['id', 'name', 'age', 'company', 'email', 'balance']; // Renamed property
  columnDefinitions = [
  ...
  ngOnInit() {
    // Simulating asynchronous data fetch with random delay
    setTimeout(() => {
  ...
  get displayedColumns() { // Using getter for dynamic columns
